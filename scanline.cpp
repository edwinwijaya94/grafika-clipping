...
// vector<Line> produceLines(vector<Point> points, int &ymax_global, int &ymin_global) {
//   int i;
//   vector<Line> vl;
//   ymin_global = 2000;
//   ymax_global = -1;
...
//       Line line;
//       line.phigh.y = points[i].y;
//       line.phigh.x = points[i].x;
//       line.plow.y = points[(i+1)%points.size()].y;
//       line.plow.x = points[(i+1)%points.size()].x;
//       vl.push_back(line);
//     }
//     else if (points[i].y < points[(i+1)%points.size()].y) {
//       Line line;
//       line.plow.y = points[i].y;
//       line.plow.x = points[i].x;
//       line.phigh.y = points[(i+1)%points.size()].y;
//       line.phigh.x = points[(i+1)%points.size()].x;
//       vl.push_back(line);
//     }
//     if (points[i].y > ymax_global) 
//       ymax_global = points[i].y;
//     if (points[i].y < ymin_global)
//       ymin_global = points[i].y;
//   }
//   return vl;
// }
